...
# find the minimum cost matching
...
def final_assignment(initial_m, m):
    ...
    while np.sum(m == 0) > 0:
        ...
        m[:, j] += 1
        assignment = assignment_single_zero_lines(m, assignment)
    return assignment * initial_m, assignment
